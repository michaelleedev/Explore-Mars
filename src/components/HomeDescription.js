            ...
            <Container fluid className="description-container">
                <div id="description-information">
                    <div className="information-content">
                        ...
                        <Button href="/ExploreMars/information" variant="secondary" className="mt-3">Learn More</Button>
                    </div>
                </div>
                 <div id="description-scenery">
                    <div className="scenery-content">
                        <h1>PLACES AND SCENARIES <br></br>TO VISIT</h1>
                        ...
                        <Button href="/ExploreMars/scenary" variant="secondary" className="mt-3">Learn More</Button>
                    </div>
                </div>
                <div id="description-activity">
                    <div className="activity-content">
                        <h1>ACTIVITIES AND EXPLORATIONS</h1>
                        ...
                        <Button href="/ExploreMars/activity" variant="secondary" className="mt-3">Learn More</Button>
                    </div>
                </div> 
            </Container>
        </div>
